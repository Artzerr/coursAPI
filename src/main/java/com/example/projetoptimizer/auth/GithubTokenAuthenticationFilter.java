...
public class GithubTokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (githubTokenWithTokenType != null) {
            var isBearerToken = githubTokenWithTokenType.startsWith(TOKEN_TYPE);
            ...
            UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(githubUser, githubToken, new ArrayList<>());
